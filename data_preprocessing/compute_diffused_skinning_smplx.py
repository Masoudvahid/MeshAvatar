...
#     fn_list = ['/tmp/data_tmp_skinning_grid/grid_00.grd', '/tmp/data_tmp_skinning_grid/grid_01.grd', '/tmp/data_tmp_skinning_grid/grid_02.grd', '/tmp/data_tmp_skinning_grid/grid_03.grd', '/tmp/data_tmp_skinning_grid/grid_04.grd', '/tmp/data_tmp_skinning_grid/grid_05.grd', '/tmp/data_tmp_skinning_grid/grid_06.grd', '/tmp/data_tmp_skinning_grid/grid_07.grd', '/tmp/data_tmp_skinning_grid/grid_08.grd', '/tmp/data_tmp_skinning_grid/grid_09.grd', '/tmp/data_tmp_skinning_grid/grid_10.grd', '/tmp/data_tmp_skinning_grid/grid_11.grd', '/tmp/data_tmp_skinning_grid/grid_12.grd', '/tmp/data_tmp_skinning_grid/grid_13.grd', '/tmp/data_tmp_skinning_grid/grid_14.grd', '/tmp/data_tmp_skinning_grid/grid_15.grd', '/tmp/data_tmp_skinning_grid/grid_16.grd', '/tmp/data_tmp_skinning_grid/grid_17.grd', '/tmp/data_tmp_skinning_grid/grid_18.grd', '/tmp/data_tmp_skinning_grid/grid_19.grd', '/tmp/data_tmp_skinning_grid/grid_20.grd', '/tmp/data_tmp_skinning_grid/grid_21.grd', '/tmp/data_tmp_skinning_grid/grid_22.grd', '/tmp/data_tmp_skinning_grid/grid_23.grd', '/tmp/data_tmp_skinning_grid/grid_24.grd', '/tmp/data_tmp_skinning_grid/grid_25.grd', '/tmp/data_tmp_skinning_grid/grid_26.grd', '/tmp/data_tmp_skinning_grid/grid_27.grd', '/tmp/data_tmp_skinning_grid/grid_28.grd', '/tmp/data_tmp_skinning_grid/grid_29.grd', '/tmp/data_tmp_skinning_grid/grid_30.grd', '/tmp/data_tmp_skinning_grid/grid_31.grd', '/tmp/data_tmp_skinning_grid/grid_32.grd', '/tmp/data_tmp_skinning_grid/grid_33.grd', '/tmp/data_tmp_skinning_grid/grid_34.grd', '/tmp/data_tmp_skinning_grid/grid_35.grd', '/tmp/data_tmp_skinning_grid/grid_36.grd', '/tmp/data_tmp_skinning_grid/grid_37.grd', '/tmp/data_tmp_skinning_grid/grid_38.grd', '/tmp/data_tmp_skinning_grid/grid_39.grd', '/tmp/data_tmp_skinning_grid/grid_40.grd', '/tmp/data_tmp_skinning_grid/grid_41.grd', '/tmp/data_tmp_skinning_grid/grid_42.grd', '/tmp/data_tmp_skinning_grid/grid_43.grd', '/tmp/data_tmp_skinning_grid/grid_44.grd', '/tmp/data_tmp_skinning_grid/grid_45.grd', '/tmp/data_tmp_skinning_grid/grid_46.grd', '/tmp/data_tmp_skinning_grid/grid_47.grd', '/tmp/data_tmp_skinning_grid/grid_48.grd', '/tmp/data_tmp_skinning_grid/grid_49.grd', '/tmp/data_tmp_skinning_grid/grid_50.grd', '/tmp/data_tmp_skinning_grid/grid_51.grd', '/tmp/data_tmp_skinning_grid/grid_52.grd', '/tmp/data_tmp_skinning_grid/grid_53.grd', '/tmp/data_tmp_skinning_grid/grid_54.grd']
#     grids = []
#     for fn in fn_list:
...
#     print('State02')
#     np.save(join(data_templates_path, 'avatarex', 'avatarex' + '_cano_lbs_weights_grid_stack.npy'), grids_all.astype(np.float32))
#     print('State03')
...
#     print('State04')
#     np.save(join(data_templates_path, 'avatarex', 'avatarex' + '_cano_lbs_weights_grid_float32.npy'), grids_all.astype(np.float32))
#     print(grids_all)
...
if __name__ == '__main__':
    ...
    if not os.path.exists(join(data_templates_path, subject, subject + '_cano_lbs_weights_grid_float32.npy')):
        ...
        grids_all = np.stack(grids, 0)
        print('State02')
        np.save(join(data_templates_path, subject, subject + '_cano_lbs_weights_grid_stack.npy'), grids_all.astype(np.float32))
        grids_all = np.clip(grids_all, 0.0, 1.0)
        print('State03')
        grids_all = grids_all / grids_all.sum(0)[None]
        print('State04')
